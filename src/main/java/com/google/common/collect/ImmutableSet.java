...
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
	...
	public static <E> Collector<E, ?, ImmutableSet<E>> toImmutableSet() {
		return Collector.of(() -> ImmutableSet.<E>builder(),
				(ImmutableSet.Builder<E> b, E e) -> {
					b.add(e);
				}, (ImmutableSet.Builder<E> b1, ImmutableSet.Builder<E> b2) -> {
					b1.addAll(b2.build());
					return b1;
				}, (ImmutableSet.Builder<E> b) -> b.build());
	}
