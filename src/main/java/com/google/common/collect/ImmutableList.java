...
public abstract class ImmutableList<E> extends ImmutableCollection<E> implements List<E>, RandomAccess {
	...
	/**
	 * Guava 21. 1.18.2 uses it heavily in stream pipelines; the vendored copy predates it.
	 */
	public static <E> Collector<E, ?, ImmutableList<E>> toImmutableList() {
		return Collector.of(() -> ImmutableList.<E>builder(),
				(ImmutableList.Builder<E> b, E e) -> {
					b.add(e);
				}, (ImmutableList.Builder<E> b1, ImmutableList.Builder<E> b2) -> {
					b1.addAll(b2.build());
					return b1;
				}, (ImmutableList.Builder<E> b) -> b.build());
	}
