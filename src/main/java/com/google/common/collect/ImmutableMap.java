...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
	...
	public static <T, K, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableMap(
		...
		return Collector.of(() -> ImmutableMap.<K, V>builder(),
				(ImmutableMap.Builder<K, V> b, T t) -> {
					b.put(keyFunction.apply(t), valueFunction.apply(t));
				}, (ImmutableMap.Builder<K, V> b1, ImmutableMap.Builder<K, V> b2) -> {
					b1.putAll(b2.build());
					return b1;
				}, (ImmutableMap.Builder<K, V> b) -> b.build());
	}
