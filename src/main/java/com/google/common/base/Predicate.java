...
public interface Predicate<T> extends java.util.function.Predicate<T> {
	...
	/**
	 * Guava 21 bridged its own functional interfaces onto the JDK's; 1.18.2 relies on
	 * that (it assigns Suppliers.memoize(..) straight into a java.util.function.Supplier).
	 */
	@Override
