...
public class ResourceLocation implements Comparable<ResourceLocation> {
   ...
   // ---- EaglercraftX ----
   // A one-slot cache so the texture and mesh loaders can hang the resolved GPU object
   // straight off the location instead of hashing the path on every lookup. Kept from
   // the 1.12.2 fork, where lax1dude added it to the same class.
