...
public abstract class GuiSlot {
	...
	protected void bindAmountScrolled() {
		this.amountScrolled = Mth.clamp(this.amountScrolled, 0.0F, (float) this.getMaxScroll());
	}
	...
	public void drawScreen(int mouseXIn, int mouseYIn, float partialTicks) {
		if (this.visible) {
			...
			this.mc.getTextureManager().bindForSetup(Screen.BACKGROUND_LOCATION);
			...
			GlStateManager.tryBlendFuncSeparate(RealOpenGLEnums.GL_SRC_ALPHA, RealOpenGLEnums.GL_ONE_MINUS_SRC_ALPHA,
					RealOpenGLEnums.GL_ZERO, RealOpenGLEnums.GL_ONE);
			...
			if (j1 > 0) {
				...
				k1 = Mth.clamp(k1, 32, this.bottom - this.top - 8);
					...
					if (this.mouseY >= this.top && this.mouseY <= this.bottom) {
						...
						if (i1 < this.getSize() && this.mouseX >= j2 && this.mouseX <= k2 && i1 >= 0 && l2 >= 0) {
							boolean flag = i1 == this.selectedElement
									&& net.minecraft.Util.getMillis() - this.lastClicked < 250L;
							this.elementClicked(i1, flag, this.mouseX, this.mouseY);
							this.selectedElement = i1;
							this.lastClicked = net.minecraft.Util.getMillis();
	...
	// ---- 1.12.2 Gui draw helpers, on the frame's ambient PoseStack ----

	public void drawRect(int left, int top, int right, int bottom, int color) {
		GuiComponent.fill(EaglerGuiCompat.currentPoseStack(), left, top, right, bottom, color);
	}

	public void drawTexturedModalRect(int x, int y, int u, int v, int width, int height) {
		GuiComponent.blit(EaglerGuiCompat.currentPoseStack(), x, y, 0, (float) u, (float) v,
				width, height, 256, 256);
	}

	public void drawString(FontRenderer font, String text, int x, int y, int color) {
		GuiComponent.drawString(EaglerGuiCompat.currentPoseStack(), font, text, x, y, color);
	}

	public void drawCenteredString(FontRenderer font, String text, int x, int y, int color) {
		GuiComponent.drawCenteredString(EaglerGuiCompat.currentPoseStack(), font, text, x, y, color);
	}
	...
	public void drawModalRectWithCustomSizedTexture(int x, int y, float u, float v, int width, int height,
		...
		GuiComponent.blit(EaglerGuiCompat.currentPoseStack(), x, y, 0, u, v, width, height,
