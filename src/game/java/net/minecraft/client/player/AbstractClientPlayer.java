...
public abstract class AbstractClientPlayer extends Player {
   ...
   // ---- EaglercraftX ----
   // Per-player animation state driven by RenderHighPoly. It lives on the entity (not in
   // a side map) because the high-poly renderer reads it once per limb per frame.
   ...
   public static void registerSkinTexture(ResourceLocation var0, String var1) {
      ...
      if (var3 == MissingTextureAtlasSprite.getTexture()) {
         HttpTexture var4 = new HttpTexture(
            ...
            DefaultPlayerSkin.getDefaultSkin(createPlayerUUID(var1)),
            true,
            null
         );
   ...
   /**
    * EaglercraftX: which of the bundled player meshes this player uses. Falls back to
    * STEVE before the server's skin packet has arrived.
    */
   public SkinModel getEaglerSkinModel() {
      PlayerInfo var1 = this.getPlayerInfo();
      return var1 == null ? SkinModel.STEVE : var1.getEaglerSkinModel();
   }
}
