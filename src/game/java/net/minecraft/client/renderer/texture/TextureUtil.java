...
public class TextureUtil {
	...
	public static final int[] MISSING_TEXTURE_DATA = null /* 1.18.2 keeps the missing texture as a NativeImage, not an int[] */;
	...
	private static void copyToBufferPos(int[] p_110994_0_, int p_110994_1_, int p_110994_2_) {
		...
		if (false /* anaglyph 3D was removed after 1.12.2 */) {
	...
	public static int[] readImageData(ResourceManager resourceManager, ResourceLocation imageLocation)
			throws IOException {
	...
	public static int[] readImageData_SWAP_RB(ResourceManager resourceManager, ResourceLocation imageLocation)
			throws IOException {
		Resource iresource = null;
		int[] aint1;
