...
public class AnimationMetadataSection {
   ...
   // ---- accessors EaglercraftX's animated-sprite code uses ----
   // 1.18.2 made frames/defaultFrameTime private and exposes them only through
   // forEachFrame; the EaglercraftX sprite walks frames by index, so the 1.12.2
   // accessors are restored here on top of the same fields.
   ...
   public int getFrameTimeSingle(int var1) {
      return this.frames.get(var1).getTime(this.defaultFrameTime);
   }

   public int getFrameIndex(int var1) {
      return this.frames.get(var1).getIndex();
   }

   public java.util.Set<Integer> getFrameIndexSet() {
      java.util.Set<Integer> var1 = new java.util.HashSet<>();
      for (AnimationFrame var3 : this.frames) {
